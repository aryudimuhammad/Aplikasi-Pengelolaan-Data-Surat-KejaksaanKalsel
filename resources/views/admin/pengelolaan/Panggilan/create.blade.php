            ...
            <form method="post">
                <div class="modal-body">
                    ...
                    <!-- <div class="form-group">
                        ...
                        <input type="text" name="no_panggilan" id="no_panggilan" class="form-control" placeholder="Masukkan Nomor Surat.." value="{{old('no_panggilan')}}">
                    </div> -->
                    <div class="form-group">
                        <label for="nama">Kepada/tersangka</label>
                        <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukkan Nama Pelapor" value="{{old('nama')}}">
                    </div>
                    <div class="form-group">
                        <label for="nik">Nik</label>
                        <input type="text" name="nik" id="nik" class="form-control" placeholder="Masukkan Nik" value="{{old('nik')}}">
                    </div>
                    <div class="form-group">
                        <label for="alias">Alias</label>
                        <input type="text" name="alias" id="alias" class="form-control" placeholder="Masukkan Nama Pelapor" value="{{old('alias')}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="ortu" id="ortu" class="form-control" placeholder="Masukkan Nama Orang Tua" value="{{old('ortu')}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="kontak" id="kontak" class="form-control" placeholder="Masukkan Kontak" value="{{old('kontak')}}">
                    </div>
                    <div class="form-group">

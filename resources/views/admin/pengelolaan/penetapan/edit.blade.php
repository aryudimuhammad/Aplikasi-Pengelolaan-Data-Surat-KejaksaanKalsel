...
@section('title') Ubah Penetapan Tersangka @endsection
@section('head')
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="breadcome-heading">
                                <h1>Ubah Penetapan Tersangka</h1>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <ul class="breadcome-menu">
                                ...
                                <li><a href="{{route('keteranganIndex')}}">Penetapan Tersangka</a> <span class="bread-slash">/</span>
                                </li>
                                <li><span class="bread-blod">Ubah Penetapan Tersangka</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="sparkline13-hd" style="margin-left: 15px; margin-right:15px;">
                        <div class=" main-sparkline13-hd">
                            ...
                            <div class="sparkline13-outline-icon" style="margin-top: -6px;">
                                <a href="{{route('penetapanIndex')}}" class="btn btn-danger color-white"><span class="fa fa-arrow-left"> Kembali</span></a>
                            </div>
                        </div>
                    </div>
                    <div class="sparkline-content" style="margin-left: 15px; margin-right:15px;">
                        <div class="datatable-dashv1-list">
                            <form method="post" action="{{route('penetapanUpdate', ['id' => $data->uuid])}}">
                                @csrf
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nomor_surat" class="form-control" placeholder="Nomor Surat.." value="{{$data->nomor_surat}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="keterangan">Keterangan</label>
                                        <textarea name="keterangan" id="summernote1" class="form-control" placeholder="Uraian">{{$data->keterangan}}</textarea>
                                    </div>
                                </div>

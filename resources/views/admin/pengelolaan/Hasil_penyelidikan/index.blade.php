...
@section('title') Pengelolaan Hasil Penyelidikan @endsection
@section('head')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <ul class="breadcome-menu">
                                ...
                                <li><span class="bread-blod">Hasil Penyelidikan</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            ...
                            <div class="sparkline13-outline-icon">
                                ...
                                <a class="btn btn-primary color-white" href="{{ route('hasilpenyelidikankeseluruhan') }}" target="_blank"><span class="fa fa-print"> Cetak Keseluruhan</span>
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <table id="table" class="table border-table nowrap" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="false" data-click-to-select="false" data-toolbar="#toolbar">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$d->permintaan_keterangan->perihal}}</td>
                                        <td>{{$d->no_pol}}</td>
                                        <td>{!!$d->isi_surat!!}</td>
                                        <td>
                                            <a style="border-radius: 5px;" target="_blank" class="btn btn-primary btn-xs" href="{{route('hasilpenyelidikanformat',['id' => $d->uuid])}}"><i class="fa fa-print" style="color: white;"></i> Cetak Surat</a>
                                            <!-- <a style="border-radius: 5px;" class="btn btn-info btn-xs"
                                                href="{{route('hasilpenyelidikanShow',['id' => $d->uuid])}}"><i
                                                    class="fa fa-search" style="color: white;"></i> Lihat</a> -->
                                            <a style="border-radius: 5px;" class="btn btn-warning btn-xs" href="{{route('hasilpenyelidikanEdit',['id' => $d->uuid])}}"><i class="fa fa-pencil" style="color: white;"></i> Edit</a>
...
@include('admin.pengelolaan.hasil_penyelidikan.create')
@include('admin.pengelolaan.hasil_penyelidikan.cetaktgl')
@endsection
...
<script>
    $(document).on('click', '.delete', function(e) {
        ...
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "{{url('/hasil/penyelidikan/delete')}}" + '/' + id,
                    type: "POST",
                    data: {
                        '_method': 'DELETE',
                        "_token": "{{ csrf_token() }}"

...
@section('title') Pengelolaan Data Keputusan Pengadilan @endsection
@section('head')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <ul class="breadcome-menu">
                                ...
                                <li><span class="bread-blod">Data Keputusan Pengadilan</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            ...
                            <div class="sparkline13-outline-icon">
                                ...
                                <a class="btn btn-primary color-white" href="{{ route('putusanpengadilankeseluruhan') }}" target="_blank"><span class="fa fa-print"> Cetak Keseluruhan</span>
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <table id="table" class="table border-table nowrap" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="false" data-click-to-select="false" data-toolbar="#toolbar">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a style="border-radius: 5px;" target="_blank" class="btn btn-primary btn-xs" href="{{route('putusanpengadilanformat',['id' => $d->uuid])}}"><i class="fa fa-print" style="color: white;"></i> Cetak Surat</a>
                                            ...
                                            <a style="border-radius: 5px;" class="btn btn-warning btn-xs" href="{{route('putusanEdit',['id' => $d->uuid])}}"><i class="fa fa-pencil" style="color: white;"></i> Edit</a>
...
@include('admin.pengelolaan.keputusan.create')
@include('admin.pengelolaan.keputusan.cetaktgl')
@endsection
...
<script>
    $(document).on('click', '.delete', function(e) {
        ...
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "{{url('/putusan/pengadilan/delete')}}" + '/' + id,
                    type: "POST",
                    data: {
                        '_method': 'DELETE',
                        "_token": "{{ csrf_token() }}"

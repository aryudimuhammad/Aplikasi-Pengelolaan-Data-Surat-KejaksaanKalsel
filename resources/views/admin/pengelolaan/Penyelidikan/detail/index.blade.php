...
@section('title') Detail Perintah Penyelidikan @endsection
@section('head')
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="breadcome-heading">
                                <h1>Detail Perintah Penyelidikan</h1>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <ul class="breadcome-menu">
                                ...
                                <li><span class="bread-blod">Detail Perintah Penyelidikan</span>
                                </li>
                            </ul>
                        </div>
                    </div>
...
@include('admin.pengelolaan.penyelidikan.detail.create')
@endsection
...
<script>
    $(document).on('click', '.delete', function(e) {
        ...
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "{{url('/perintah/penyelidikan/detail/delete')}}" + '/' + id,
                    type: "POST",
                    data: {
                        '_method': 'DELETE',
                        "_token": "{{ csrf_token() }}"

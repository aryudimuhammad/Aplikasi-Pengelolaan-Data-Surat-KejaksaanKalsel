            ...
            <form method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nrp" id="nrp" class="form-control" placeholder="Masukkan NRP" value="{{old('nrp')}}">
                    </div>
                    <div class="form-group">
                        <label for="jabatan">Jabatan</label>
                        <select name="jabatan" id="jabatan" class="form-control">
                            @foreach($jabatan as $d)
                            <option value="{{$d->id}}" @if (old('jabatan')==$d->id) {{ 'selected' }} @endif>{{$d->jabatan}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="pangkat" id="pangkat" class="form-control">
                            ...
                            <option value="{{$d->id}}" @if (old('pangkat')==$d->id) {{ 'selected' }} @endif>{{$d->pangkat}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="telp">Telepon</label>
                        <input type="text" name="telp" id="telp" class="form-control" placeholder="Masukkan Telepon" value="{{old('telp')}}">
                    </div>
                    <div class="form-group">

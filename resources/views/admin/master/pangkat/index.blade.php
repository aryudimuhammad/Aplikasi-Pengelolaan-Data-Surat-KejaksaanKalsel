                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <ul class="breadcome-menu">
                                ...
                                <li><span class="bread-blod">Data Pangkat</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <table id="table" class="table border-table nowrap" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="false" data-click-to-select="false" data-toolbar="#toolbar">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$d->pangkat}}</td>
                                        <td>
                                            <a style="border-radius: 5px;" class="btn btn-warning btn-xs" data-id="{{$d->id}}" data-pangkat="{{$d->pangkat}}" data-toggle="modal" data-target="#modaledit"><i class="fa fa-pencil" style="color: white;"></i> Edit</a>
...
@include('admin.master.pangkat.create')
@include('admin.master.pangkat.edit')
@endsection

...
<head>
    ...
    <title>Laporan Surat Perintah Penyelidikan</title>
...
<body>
    ...
    <div class="container" style="margin-top:-40px;">
        <h3 style="text-align:center;text-transform: uppercase;">Laporan Surat Perintah Penyelidikan (P-2)</h3>

        <table class='table table-bordered nowrap'>
            <thead>
                <tr>
                    <th scope="col" class="text-center">No</th>
                    <th scope="col" class="text-center">Dari Laporan</th>
                    <th scope="col" class="text-center">Nomor Surat</th>
                    <th scope="col" class="text-center">Diperintahkan</th>
                    <th scope="col" class="text-center">Dikeluarkan di Kota</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td scope="col" class="text-center">{{ $d->surat_terima->nama_pelapor }}</td>

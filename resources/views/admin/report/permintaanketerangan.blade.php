...
<head>
    ...
    <title>Laporan Surat Permintaan Keterangan</title>
...
<body>
    ...
    <div class="container" style="margin-top:-40px;">
        <h3 style="text-align:center;text-transform: uppercase;">Laporan Surat Permintaan Keterangan(P-4)</h3>

        <table class='table table-bordered nowrap'>
            <thead>
                <tr>
                    <th scope="col" class="text-center">No</th>
                    <th scope="col" class="text-center">Dari No.Penyelidikan</th>
                    ...
                    <th scope="col" class="text-center">Di Kota</th>

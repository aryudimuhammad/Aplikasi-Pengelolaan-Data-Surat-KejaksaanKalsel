        ...
        <table class='table table-bordered nowrap'>
            <thead>
                <tr>
                    ...
                    <th scope="col" class="text-center">Dari Hasil Penyelidikan</th>
                    <th scope="col" class="text-center">No.Penyidikan</th>
                    <th scope="col" class="text-center">Diperintahkan</th>
                    <th scope="col" class="text-center">Dikeluarkan di</th>

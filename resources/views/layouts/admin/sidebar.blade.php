<div class="left-sidebar-pro">
    <nav id="sidebar">
        <div class="sidebar-header">
            <a href="{{route('settingIndex')}}"><img src="{{ url('images/profile/'. Auth::user()->gambar )}}"
        ...
        <div class="left-custom-menu-adp-wrap">
            <ul class="nav navbar-nav left-sidebar-menu-pro">
                <li class="nav-item">
                    <a href="{{route('dashboard')}}"><i class="fa big-icon fa-tachometer"></i> <span
                            class="mini-dn">Dashboard</span></a>
                </li>
                <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false"
                        class="nav-link dropdown-toggle"><i class="fa big-icon fa-server"></i> <span
                            class="mini-dn">Data Master</span> <span class="indicator-right-menu mini-dn"><i
                    ...
                    <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                        ...
                        <a href="{{route('jenisaduanIndex')}}" class="dropdown-item">Data Jenis Aduan</a>
                        <a href="{{route('wargaIndex')}}" class="dropdown-item">Data Warga</a>
                    </div>
                </li>
                <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false"
                        class="nav-link dropdown-toggle"><i class="fa big-icon fa-dropbox"></i> <span
                            class="mini-dn">Pengelolaan</span> <span class="indicator-right-menu mini-dn"><i
                                class="fa indicator-mn fa-angle-left"></i></span></a>
                    <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                ...
                <li class="nav-item"><a href="{{route('settingIndex')}}" role="button" aria-expanded="false"
                        class="nav-link"><i class="fa big-icon fa-cogs"></i> <span class="mini-dn">Setting</span> </a>
                </li>
                <li class="nav-item"><a href="{{route('userIndex')}}" role="button" aria-expanded="false"
                        class="nav-link"><i class="fa big-icon fa-users"></i> <span class="mini-dn">Admin</span> </a>
                </li>
            </ul>
        </div>
    </nav>
